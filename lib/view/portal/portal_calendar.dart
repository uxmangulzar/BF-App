...
class ProtalAvailability extends StatefulWidget {
  const ProtalAvailability({Key? key}) : super(key: key);

  @override
  State<ProtalAvailability> createState() => _ProtalAvailabilityState();
}

class _ProtalAvailabilityState extends State<ProtalAvailability> {
  Select select = Select.soonest;
  @override
  Widget build(BuildContext context) {
    return
PortalScaffold(body:   Responsive(desktop:  Row(
  children: [
